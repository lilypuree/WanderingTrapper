...
public class Registration {
    ...
    public static void registerPOIs(RegistryEvent.Register<PoiType> event) {
        event.getRegistry().register(RegistryObjects.FURRIER_POI = RegistrySuppliers.FURRIER_POI.get().setRegistryName(RegistryNames.FURRIER));
    }

    @SubscribeEvent
    public static void registerVillagers(RegistryEvent.Register<VillagerProfession> event) {
        event.getRegistry().register(RegistryObjects.FURRIER = RegistrySuppliers.FURRIER.get().setRegistryName(RegistryNames.FURRIER));
    }
}
