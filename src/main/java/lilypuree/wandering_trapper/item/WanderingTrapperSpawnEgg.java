        ...
        if (world.isRemote) {
            ...
            if (block == Blocks.SPAWNER) {
                ...
                if (tileentity instanceof MobSpawnerTileEntity) {
                    ...
                    abstractspawner.setEntityType(Registration.WANDERING_TRAPPER.get());
            ...
            if (Registration.WANDERING_TRAPPER.get().spawn(world, itemstack, context.getPlayer(), blockpos1, SpawnReason.SPAWN_EGG, true, !Objects.equals(blockpos, blockpos1) && direction == Direction.UP) != null) {
                itemstack.shrink(1);
            }
